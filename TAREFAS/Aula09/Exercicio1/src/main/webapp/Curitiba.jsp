...
<table>
		<tr>
		<td>
			<input type="text" name="Valor_Area_CB" size="30"  id="Valor_Area_CB" placeholder="Área"> 
			<input type="text" name="Idade_Imovel_CB" size="30"  id="Idade_Imovel_CB" placeholder="Idade do Imóvel"> 
